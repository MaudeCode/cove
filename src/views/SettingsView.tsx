...
\`\`\``;
    return sanitizeHtml(renderMarkdown(previewMarkdown));
  }, []);
          ...
          <div class="space-y-2">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
              ...
              <div class="flex-shrink-0">
                <Dropdown
                  value={codeFontFamily.value}
                  onChange={(value) => {
                    codeFontFamily.value = value as CodeFontFamily;
                  }}
                  options={CODE_FONT_FAMILY_OPTIONS.map((opt) => ({
                    value: opt.value,
                    label: t(opt.labelKey),
                  }))}
                  size="sm"
            ...
            <div
              class="message-content prose prose-sm max-w-none w-full [&_pre.code-block]:m-0"
              // biome-ignore lint/security/noDangerouslySetInnerHtml: preview HTML is generated by renderMarkdown and sanitized by DOMPurify
